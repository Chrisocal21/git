...
const AIRPORT_INFO: Record<string, AirportInfo> = {
  ...
  'OAJ': { coords: [34.8292, -77.6121], city: 'Jacksonville', state: 'NC', name: 'Albert J. Ellis' },
  'CRQ': { coords: [33.1283, -117.2803], city: 'Carlsbad', state: 'CA', name: 'McClellan-Palomar' },
  'MYF': { coords: [32.4759, -117.1400], city: 'San Diego', state: 'CA', name: 'Montgomery-Gibbs' },
  'SDM': { coords: [32.5723, -116.9803], city: 'San Diego', state: 'CA', name: 'Brown Field' },
  'SEE': { coords: [32.8262, -116.9724], city: 'El Cajon', state: 'CA', name: 'Gillespie Field' },
  'PSP': { coords: [33.8297, -116.5067], city: 'Palm Springs', state: 'CA', name: 'International' },
  'SBA': { coords: [34.4262, -119.8404], city: 'Santa Barbara', state: 'CA', name: 'Santa Barbara Airport' },
  'LGB': { coords: [33.8177, -118.1516], city: 'Long Beach', state: 'CA', name: 'Long Beach Airport' },
  'VNY': { coords: [34.2098, -118.4899], city: 'Van Nuys', state: 'CA', name: 'Van Nuys Airport' },
  'SMO': { coords: [34.0158, -118.4513], city: 'Santa Monica', state: 'CA', name: 'Santa Monica Airport' },
  'FUL': { coords: [33.8720, -117.9797], city: 'Fullerton', state: 'CA', name: 'Fullerton Municipal' },
  'CMA': { coords: [34.2137, -119.0943], city: 'Camarillo', state: 'CA', name: 'Camarillo Airport' },
  'IYK': { coords: [35.6588, -117.8298], city: 'Inyokern', state: 'CA', name: 'Inyokern Airport' },
  'EWN': { coords: [35.0730, -77.0429], city: 'New Bern', state: 'NC', name: 'Coastal Carolina Regional' },
  'ILM': { coords: [34.2706, -77.9026], city: 'Wilmington', state: 'NC', name: 'International' },
  'MYR': { coords: [33.6797, -78.9283], city: 'Myrtle Beach', state: 'SC', name: 'International' },
  'FAY': { coords: [34.9912, -78.8803], city: 'Fayetteville', state: 'NC', name: 'Regional' },
  'AVL': { coords: [35.4362, -82.5418], city: 'Asheville', state: 'NC', name: 'Regional' },
  'GSP': { coords: [34.8957, -82.2189], city: 'Greer', state: 'SC', name: 'Greenville-Spartanburg' },
  'CAE': { coords: [33.9388, -81.1195], city: 'Columbia', state: 'SC', name: 'Metropolitan' },
  // Northeast additions
  ...
  'MBJ': { coords: [18.5037, -77.9134], city: 'Montego Bay', state: 'JM', name: 'Sangster Int.' },
  'KIN': { coords: [17.9357, -76.7875], city: 'Kingston', state: 'JM', name: 'Norman Manley Int.' },
  'OCJ': { coords: [18.4038, -76.9662], city: 'Ocho Rios', state: 'JM', name: 'Ian Fleming Int.' },
  'NAS': { coords: [25.0389, -77.4662], city: 'Nassau', state: 'BS', name: 'Lynden Pindling Int.' },
  'PUJ': { coords: [18.5674, -68.3634], city: 'Punta Cana', state: 'DO', name: 'Punta Cana Int.' },
  'SDQ': { coords: [18.4297, -69.6689], city: 'Santo Domingo', state: 'DO', name: 'Las Americas Int.' },
  'SJU': { coords: [18.4394, -66.0018], city: 'San Juan', state: 'PR', name: 'Luis Munoz Marin Int.' },
  'AUA': { coords: [12.5014, -70.0152], city: 'Oranjestad', state: 'AW', name: 'Queen Beatrix Int.' },
  'BGI': { coords: [13.0746, -59.4925], city: 'Bridgetown', state: 'BB', name: 'Grantley Adams Int.' },
  'GCM': { coords: [19.2928, -81.3577], city: 'George Town', state: 'KY', name: 'Owen Roberts Int.' },
  'STT': { coords: [18.3373, -64.9734], city: 'St. Thomas', state: 'VI', name: 'Cyril E. King' },
  ...
  'STN': { coords: [51.8850, 0.2350], city: 'London', state: 'UK', name: 'Stansted' },
  'MAN': { coords: [53.3537, -2.2750], city: 'Manchester', state: 'UK', name: 'Manchester' },
  ...
  'BER': { coords: [52.3667, 13.5033], city: 'Berlin', state: 'DE', name: 'Brandenburg' },
